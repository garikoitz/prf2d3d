...
for na=1:length(an_types)
    ...
    switch an
        case 'sensotive_blind'
            % Prepare data and defaults
            load(fullfile(prf2d3dRP,'DATA','mats', 'rmroicell_sensotive_blind.mat'));
        ...
        case 'sensotive_sight'
            % Prepare data and defaults
            load(fullfile(prf2d3dRP,'DATA','mats', 'rmroicell_sensotive_sighted.mat'));
        ...
        case 'votcloc_bhd2pilots'
            % Prepare data and defaults
            load(fullfile(prf2d3dRP,'DATA','mats', 'rmroicell_VOTCLOC_2BHDpilots.mat'));
        ...
        case 'sight_blind'            
            % Prepare data and defaults
            A = load(fullfile(prf2d3dRP,'DATA','mats', 'rmroicell_sensotive_sighted.mat'));
            B = load(fullfile(prf2d3dRP,'DATA','mats', 'rmroicell_sensotive_blind.mat'));
            
            A.rmroiCell = A.rmroiCell(1:3,:,1:2);
            A.rmroiCell(:,:,2) = B.rmroiCell(:,:,1); % CB in sight substituted by Words in blind

            rmroiCell = A.rmroiCell;
    ...
    % Plot it
    fontsize = 12;
    fname = ['LEFT_scatterplot_eccentricity_WVsCB_5VentralROIs_4subs_Fit_v01'];
